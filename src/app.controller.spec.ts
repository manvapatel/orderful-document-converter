...
describe('AppController', () => {
  ...
  describe('root', () => {
    ...
    it('String -> JSON', async () => {
      ...
      .send(reqBody)
      .expect(201);
      console.log('---res is ', response.text);
      // expect(response.text).to.equal(xmlFormat);
    })
  });
});
